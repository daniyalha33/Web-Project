  ...
  return (
    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='hidden md:flex flex-start gap-5 font-medium'>
        ...
        <hr className='border-none outline-none bg-primary h-0.5 m-auto w-3/5 hidden' />
        </NavLink>
        <NavLink to='/doctors'>
      ...
      <div className='flex items-center gap-4 '>
        ...
        <div className='flex items-center gap-2 cursor-pointer group relative'>
          <img className='w-8 rounded-full' src={token?userData.image:assets.profile_pic} alt="" />
        ...
        </div>:<button onClick={()=>navigate('/login')} className='bg-primary font-light text-white rounded-full  px-8 py-3 hidden md:block'>Create Account</button>}
